...
Created `process_data.py` and ran with `summary.tsv` to make a markdown file that summarizes general stats and has a plot of the percentage of reads assigned to each sample. Saved to [results.md](results.md)